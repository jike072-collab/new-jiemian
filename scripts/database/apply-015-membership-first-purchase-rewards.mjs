...
const version = "015_membership_first_purchase_rewards";
...
const pool = new Pool({
  ...
  query_timeout: 15000,
  application_name: "aohuang_apply_membership_first_purchase_rewards_015",
});
...
try {
  ...
  if (existing.rows[0]) {
    if (existing.rows[0].checksum !== checksum) throw new Error("Migration 015 checksum mismatch.");
