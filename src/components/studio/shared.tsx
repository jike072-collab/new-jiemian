...
function providerUseCase(model: string, displayName: string, videoOptions?: FrontendProvider["videoOptions"]) {
  ...
  if (normalized === "sdquan-2") return "930 · 满血 · 过真人 · 支持 9 图 · 3 音频 · 15 秒 · 720P";
  if (normalized === "video-2.0-fast-720p") return "413 · Fast · 过真人 · 支持 4 图 · 3 视频 · 1 音频 · 10/15 秒 · 720P";
  if (normalized === "seedance-fast-720p-pf") return "933 · Fast · 支持 9 图 · 3 视频 · 3 音频 · 4-15 秒 · 720P · 卡真人";
  if (normalized === "seedance-2.0-930") return "930 · 满血 · 过真人 · 支持 9 图 · 3 音频 · 15 秒 · 720P";
  if (normalized === "quanneng2.0-9tu") return "900 · 过真人 · 支持 9 图 · 15 秒 · 720P";
  if (normalized === "seedance2.0-9tu-manxue") return "900 · 满血 · 支持 9 图 · 15 秒 · 720P · 卡真人";
  if (normalized === "video-standard-720p") return "933 · 满血 · 过真人 · 支持 9 图 · 3 视频 · 3 音频 · 15 秒 · 720P";
  if (normalized === "b-quannengship2.0") return "900 · 线路 B · 过真人 · 支持 9 图 · 5/10/15 秒 · 720P";
  if (normalized === "video-standard-720p-fast") return "933 · Fast · 过真人 · 支持 9 图 · 3 视频 · 3 音频 · 15 秒 · 720P";
  if (normalized === "quanneng2.0") return "413 · 线路 S · 过真人 · 支持 4 图 · 3 视频 · 1 音频 · 10/15 秒 · 720P";
