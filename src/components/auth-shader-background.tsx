...
void main() {
  ...
  float ribbonA = wave(p, 0.22, 4.5 - u_mobile, 0.4);
  float ribbonB = wave(vec2(p.x * 0.72, p.y + 0.18), -0.16, 5.8 - u_mobile, 1.8);
  float ribbon = smoothstep(0.46, 0.94, ribbonA * 0.52 + ribbonB * 0.48);
  ...
  vec3 color = base;
  color += purple * (0.25 + leftGlow * 0.28);
  color += magenta * ribbon * (0.16 + leftGlow * 0.22);
  color += pink * ripple * 0.08;
