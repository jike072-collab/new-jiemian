...
export default async function CanvasPage() {
  ...
  return <CanvasWorkspace accountName={session.user.display_name || session.user.username} isTeamOwner={isInternal ? access?.role === "owner" : !session.user.account_owner_id} isInternalCanvas={isInternal} />;
}
