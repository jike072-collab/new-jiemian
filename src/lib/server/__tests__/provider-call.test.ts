...
test("Seedance defaults expose the Redbird Seedance 2.0 model catalog", () => {
  ...
  assert.equal(seedanceProvider?.modelDisplayNames?.["sdquan-2"], "930 · 满血 · 过真人");
  assert.equal(seedanceProvider?.modelDisplayNames?.["video-2.0-fast-720P"], "413 · Fast 720P · 过真人");
  assert.equal(seedanceProvider?.modelDisplayNames?.["quanneng2.0-9tu"], "900 · 9 图 · 过真人");
  assert.equal(seedanceProvider?.modelDisplayNames?.["seedance2.0-9tu-manxue"], "900 · 满血 9 图 · 卡真人");
  assert.equal(seedanceProvider?.modelDisplayNames?.["quanneng2.0"], "413 · 线路 S · 过真人");
  ...
  assert.equal(seedanceLibraryModelName("video-2.0-fast-720P"), "Seedance 2.0 · 413 · Fast 720P · 过真人");
  assert.equal(seedanceLibraryModelName("B-quannengship2.0"), "Seedance 2.0 · 900 · 线路 B · 过真人");
