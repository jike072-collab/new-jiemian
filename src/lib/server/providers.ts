...
export function defaultProviders(): ProviderConfig[] {
  return [
    ...
    },
    {
      ...
      title: "视频生成",
      role: "文生视频与图生视频",
      apiUrl: env("VIDEO_API_URL", "https://api.manxiaobai.online/v1/videos"),
      model: env("VIDEO_MODEL", "grok-video-1.0"),
      displayName: env("VIDEO_DISPLAY_NAME", env("VIDEO_MODEL", "Grok video model")),
